...
// export const templateCards = document.querySelector('#elements-add');
...
// export const templateCard = document.querySelector('#elements-add').content.querySelector('.elements__item');
